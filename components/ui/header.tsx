    ...
    <header className="absolute w-full z-30">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-20">
          <div className="shrink-0 mr-4 text-center">
            <Link href="/" className="block" aria-label="Cruip">
              <img
                src="/images/Logo_Lebull - Light.svg"
                style={{ width: "100px" }}
              />
            </Link>
          </div>
          ...
          <nav className="hidden md:flex md:grow">
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link
                  href="https://m.twitch.tv/pedro77alves"
                  className="btn-sm text-white ml-2 p-3"
                  style={{ backgroundColor: "#000 ", borderRadius: 200 }}
                >
                  <svg
                    ...
                    fill="#000000"
                    viewBox="0 0 256 256"
                    className="w-8 h-8 fill-current text-white-400"
                  >
              ...
              <li>
                <Link
                  href="https://www.instagram.com/pedro.n.alves/"
                  className="btn-sm text-white ml-2 px-2"
                  style={{ backgroundColor: "#F2A241 ", borderRadius: 200 }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="32"
              ...
              <li>
                <Link
                  href="https://discord.gg/yUxNMyGQZ4"
                  className="btn-sm text-white ml-2 px-2"
                  style={{ backgroundColor: "#000 ", borderRadius: 200 }}
                >
                  <svg
